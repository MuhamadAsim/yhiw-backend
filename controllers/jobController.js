...
export const findProvider = async (req, res) => {
  try {
    ...
    // Create job with the exact structure from frontend
    const job = new Job({
      jobNumber,
      customerId,
      ...
      // Locations - Match frontend structure
      pickupLocation: {
      ...
      // Store all frontend data in metadata
      metadata: {
        vehicle,
        customer,
        additionalDetails,
    ...
    console.log('✅ Booking ID:', job.bookingId); // This is auto-generated by pre-save
    ...
    // Prepare data for WebSocket notification to providers
    const jobRequestData = {
      jobId: job._id.toString(),
      bookingId: job.bookingId || job._id.toString(), // Use the auto-generated bookingId
      jobNumber: job.jobNumber,
      serviceType: serviceCategory,
